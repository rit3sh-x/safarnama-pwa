          ...
          <CredenzaContent className="sm:max-w-md">
            ...
            <CredenzaBody className="space-y-3">
              <p className="text-sm text-muted-foreground">
                Add an optional message to your request. The trip admin will
                review it.
              </p>
              <textarea
                ...
                rows={3}
                className="w-full resize-none rounded-xl border border-input bg-transparent p-3 text-sm outline-none transition-colors placeholder:text-muted-foreground/50 focus:border-ring"
              />
            </CredenzaBody>
