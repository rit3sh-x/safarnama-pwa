...
import { SendHorizontalIcon, XIcon, Loader2Icon, SmileIcon } from "lucide-react"
    ...
    >
      <DrawerContent className="max-h-[85vh]">
        <DrawerHeader className="flex flex-row items-center justify-between">
          <DrawerTitle>Send Image</DrawerTitle>
          <Button
            variant="ghost"
            size="icon"
            className="h-8 w-8"
          ...
          {previewUrl && (
            <div className="flex flex-1 items-center justify-center overflow-hidden rounded-xl bg-muted/50">
              <img
                src={previewUrl}
                alt="Preview"
                className="max-h-[40vh] max-w-full rounded-xl object-contain"
              />
            </div>
          )}
          ...
          <div className="relative flex items-end gap-2">
            <div className="min-w-0 flex-1">
              <textarea
                ...
                className="block w-full resize-none rounded-2xl border border-input bg-input/30 px-4 py-2.5 text-[15px] leading-relaxed text-foreground transition-colors outline-none placeholder:text-muted-foreground focus:border-ring focus:ring-1 focus:ring-ring/30 disabled:opacity-50"
              />
            </div>
